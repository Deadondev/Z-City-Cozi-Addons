...
--
		...
		for tab, things in pairs(inv) do
			...
			for k, i in ipairs(keys) do
				...
				count2 = count2 + (!ent.foundloot[i] and 0.2 or 0)//((ent:IsPlayer() or ent:IsRagdoll()) and ((hg.TraitorLoot[i] and ent:IsPlayer()) and 1 or 0.5) or 0.75) * (not ent.foundloot[i] and 1 or 0) --count2 = count2 + (!ent.foundloot[i] and 1 or 0)//((ent:IsPlayer() or ent:IsRagdoll()) and ((hg.TraitorLoot[i] and ent:IsPlayer()) and 2 or 0.5) or 1) * (not ent.foundloot[i] and 1 or 0)
				...
				button.Created = CurTime() + count2 --button.Created = CurTime() + (!ent.foundloot[i] and 2 or 0) + count2
