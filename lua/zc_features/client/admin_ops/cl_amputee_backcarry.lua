...
hook.Add("HUDPaint", "ZC_AmputeeBackCarryIndicator", function()
    ...
    draw.RoundedBox(4, cx - 45, cy - 15, 60, 30, Color(40, 40, 40, a))
    draw.SimpleText("Use", "HomigradFontMedium", cx - 15, cy, Color(COL_KEY.r, COL_KEY.g, COL_KEY.b, a), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    ...
    draw.SimpleText(targetName, "HomigradFontSmall", cx - 5, cy + 18, Color(COL_NAME.r, COL_NAME.g, COL_NAME.b, a), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
