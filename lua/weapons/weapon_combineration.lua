...
SWEP.PrintName = "Combine Rations"
SWEP.Instructions = "You gotta be damn hungry to wait in line for this crap."
...
if CLIENT then
	SWEP.WepSelectIcon = Material("vgui/w_package")
	SWEP.IconOverride = "vgui/w_package.png"
...
function SWEP:InitializeAdd()
	...
	self:SetCurModel( "models/weapons/w_package.mdl" )
	self.WorldModel = "models/weapons/w_package.mdl"
	if SERVER then
...
if SERVER then
	...
	function SWEP:Heal(ent, mode)
		...
		org.brain = org.brain + 0.01 --looks low but you eat this whole thing and you fuck your shit up pretty bad.
